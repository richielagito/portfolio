...
const ExperienceItem = ({ exp, index, total }) => {
    ...
    return (
        <motion.div
            ...
            transition={{ duration: 0.6, delay: index * 0.15, ease: [0.2, 0.65, 0.3, 0.9] }}
...
const Experiences = () => {
    ...
    return (
        <section id="experiences" className="py-24">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-20 md:pl-[calc(33.33%+3rem)]">
            ...
            <div ref={timelineRef} className="relative">
                ...
                <div className="hidden md:block absolute left-1/3 top-0 bottom-0 w-px">
                    ...
                    {/* Animated fill */}
                    <motion.div className="absolute top-0 left-0 w-full bg-gradient-to-b from-neutral-500 via-neutral-600 to-transparent" style={{ height: lineHeight }} />
                </div>
                ...
                <div className="flex flex-col pl-8 md:pl-0">
                    {experiencesData.map((exp, index) => (
                        <div key={exp.id} className="relative">
                            ...
                            <ExperienceItem exp={exp} index={index} total={experiencesData.length} />
                        </div>
                    ))}
                </div>
            </div>
