...
const Contact = () => {
    return (
        <section id="contact" className="py-32 flex flex-col items-center justify-center text-center">
            <m.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }} className="flex flex-col items-center">
                ...
                <div className="flex gap-8 mt-16">
                    {[
                        ...
                        <m.a key={social.link} href={social.link} target="_blank" rel="noopener noreferrer" whileHover={{ y: -5 }} className="text-neutral-500 hover:text-foreground transition-colors text-2xl">
